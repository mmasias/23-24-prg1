public class Reto002 {
    public static void main(String[] args) {
         ...
         int cantidadPagar=654;
         int cantidadPagada=800;
         int cantidad_devolver=cantidadPagada-cantidadPagar;
        ...
        System.out.println("Tienes que pagar " + cantidadPagar + "€");
        System.out.println("Has pagado " + cantidadPagada + "€");
