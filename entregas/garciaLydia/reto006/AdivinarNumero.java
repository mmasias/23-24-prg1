...
public class AdivinarNumero {
    public static void main(String[] args) {
        ...
        int respuesta = 0;
        final String PREGUNTA = "Dime (1 SI / 2 NO) si el número está en la tarjeta ";
        ...
        respuesta = scanner.nextInt();
        if (respuesta == 1) {
            numeroPorAdivinar += 64;
        }

        System.out.println("El número que pensaste es: " + numeroPorAdivinar);
    }
}
