package entregas.palmaCamila.reto006;

import java.util.Scanner;

public class LecturaCartas {
  public static void main(String[] args) {
        ...
        System.out.println("+---------------+");
        System.out.print("Está aquí? (1:SI / 2:NO): ");
        result += (scanner.nextInt() == 1) ? 2 : 0;

        System.out.println("\nTARJETA 3");
        System.out.println("+---------------+");
        System.out.println("| 4 24 44 64 84 |");
        System.out.println("| 5 25 45 65 85 |");
        ...
        System.out.println("|73 82 92    |");
        System.out.println("|73 83 93    |");
        System.out.println("+---------------+");
        System.out.print("Está aquí? (1:SI / 2:NO): ");
        result += (scanner.nextInt() == 1) ? 64 : 0;

        System.out.println("\nEl número pensado es " + result);
