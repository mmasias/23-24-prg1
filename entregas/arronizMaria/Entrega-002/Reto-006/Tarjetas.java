...
class Tarjetas {
	public static void main(String[] args) {
		...
		final String PREGUNTA = "Está en esta tarjeta? (1:SI / 0:NO)";
		...
		System.out.println("| 6 28 46 68 87|");
		...
		System.out.println("+--------------+");
		System.out.println("| 8 26 44 62 84|");
		...
		System.out.println(" ");
		System.out.println("El núemro que pensaste es " + numeroPorAdivinar);
