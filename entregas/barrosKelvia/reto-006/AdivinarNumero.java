...
class AdivinarNumero {
    ...
    public static void main(String[] arg) {
        ...
        final String Question = "Dime (1 SI / 2 NO) si esta en la tarjeta numero ";
        ...
        theCard = 1;
        firstNumber = 1;
        System.out.print(Question + theCard + ": ");
        Answer = scanner.nextInt();
        if (Answer == 1) {
            numberToGuess = numberToGuess + firstNumber;
        }
        ...
        System.out.println("+----------------+");
        System.out.println("|  8 26 44 92 88 |");
        ...
        System.out.println("El número que pensaste es: " + numberToGuess);
