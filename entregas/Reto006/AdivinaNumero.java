...
public class AdivinaNumero {
    ...
    public static void main (String[] args){
      ...
      int numeroUsuario, numero,suma= 0, resultado;


      System.out.println("Escoge un número del 1 al 99 ");
      System.out.println("Utiliza un 1 para decir que SI aparece y un 2 para decir que NO aparece");
     

       System.out.println("¿Aparece tu número?");
      ...
      System.out.println("Pasemos al siguiente");
  ...
  suma=suma+numero;
  System.out.println("Perfecto, pasemos al siguiente");
  ...
  System.out.println("Tu número es el " + resultado);
