...
public class adivinarNumero {
    public static void main(String[] args) {
        ...
        System.out.println("Piensa en un numero comprendido entre el 1 y el 99...");
        ...
        System.out.println("¿Su numero aparece en la tarjeta 1? S/N");

        apareceNumero = tc.next().charAt(0);

        if (apareceNumero == 'S') {

            System.out.println("Su numero aparece en la tarjeta 1");
            numeroFinal = numeroFinal++;

        } else {
            System.out.println("Su numero no aparece en la tarjeta 1");
        ...
        System.out.println("¿Su numero aparece en la tarjeta 2? S/N");

        apareceNumero = tc.next().charAt(0);

        if (apareceNumero == 'S') {

            System.out.println("Su numero aparece en la tarjeta 2");
            numeroFinal = numeroFinal + 2;

        } else {
            System.out.println("Su numero no aparece en la tarjeta 2");
        ...
        System.out.println("¿Su numero aparece en la tarjeta 3? S/N");

        apareceNumero = tc.next().charAt(0);

        if (apareceNumero == 'S') {

            System.out.println("Su numero aparece en la tarjeta 3");
            numeroFinal = numeroFinal + 4;

        } else {
            System.out.println("Su numero no aparece en la tarjeta 3");
        ...
        System.out.println("¿Su numero aparece en la tarjeta 4? S/N");

        apareceNumero = tc.next().charAt(0);

        if (apareceNumero == 'S') {

            System.out.println("Su numero aparece en la tarjeta 4");
            numeroFinal = numeroFinal + 8;

        } else {
            System.out.println("Su numero no aparece en la tarjeta 4");
        ...
        System.out.println("¿Su numero aparece en la tarjeta 5? S/N");

        apareceNumero = tc.next().charAt(0);

        if (apareceNumero == 'S') {

            System.out.println("Su numero aparece en la tarjeta 5");
            numeroFinal = numeroFinal + 16;

        } else {
            System.out.println("Su numero no aparece en la tarjeta 5");
        ...
        System.out.println("¿Su numero aparece en la tarjeta 6? S/N");

        apareceNumero = tc.next().charAt(0);

        if (apareceNumero == 'S') {

            System.out.println("Su numero aparece en la tarjeta 6");
            numeroFinal = numeroFinal + 32;

        } else {
            System.out.println("Su numero no aparece en la tarjeta 6");
        ...
        System.out.println("¿Su numero aparece en la tarjeta 7? S/N");

        apareceNumero = tc.next().charAt(0);

        if (apareceNumero == 'S') {

            System.out.println("Su numero aparece en la tarjeta 7");
            numeroFinal = numeroFinal + 64;

        } else {
            System.out.println("Su numero no aparece en la tarjeta 7");

        }

        System.out.println("Listo.");
        System.out.println("Su numero es... [ + " + numeroFinal + " ]");
