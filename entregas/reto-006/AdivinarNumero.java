...
public class AdivinarNumero {
    public static void main(String[] args) {
        ...
        final String MENSAJE = "Esta el numero que ha pensado en la tarjeta? (1(si) o 2(No)): ";
        ...
        System.out.print(MENSAJE + "en la tarjeta" + numeroTarjeta + ": ");
        respuesta = scanner.nextInt();
        if (respuesta == 1) {
            numeroAdivinar += primerNumero;
        }
