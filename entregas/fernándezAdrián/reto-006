class AdivinarTarjeta{
	...
	public static void main(String[] args) {
		...
		final String PREGUNTA = "Dime (1 Si / 2 No) si esta en la targeta numero";
		...
		System.out.println("| 5 23 43 63 83 |");
		...
		System.out.print("Estas pensando en el numero  " + numeroPorAdivinar);
