...
class AdivinarNumeroPensado {
    public static void main(String[] args) {

        Scanner scanner = new Scanner(System.in);
        int respuesta;

        final String LINEA_SEPARACIÓN_TARJETAS = "------------------------------------------------------------------------------------------";
        final String LINEA_BORDES = "+---------------+";
        final String PREGUNTA = "Dime (1 SI / Cualquier otro número significa NO) si el número que pensaste está en la tarjeta número ";

        int laTarjeta = 1;
        int primerNumero = 1;
        int numeroPorAdivinar = 0;

        System.out.println("Piense un número entre el 1 y el 99 sin escribirlo");
        System.out.println(LINEA_SEPARACIÓN_TARJETAS);
        System.out.println("La primera tarjeta es:");
        System.out.println(LINEA_BORDES);
        ...
        System.out.println("La segunda tarjeta es:");
        System.out.println(LINEA_BORDES);
        ...
        System.out.println("La tercera tarjeta es:");
        System.out.println(LINEA_BORDES);
        ...
        System.out.println("La cuarta tarjeta es:");
        System.out.println(LINEA_BORDES);
        ...
        System.out.println("La quinta tarjeta es:");
        System.out.println(LINEA_BORDES);
        ...
        System.out.println("La sexta tarjeta es:");
        System.out.println(LINEA_BORDES);
        ...
        System.out.println("El numero que pensaste fue " + numeroPorAdivinar);
